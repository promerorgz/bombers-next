...
if(typeof "9.5.4"!=='string'){return[];}const userConfiguration=getNextConfig(phase,dir);const payload={nextVersion:"9.5.4",nodeVersion:process.version,cliCommand:event.cliCommand,isSrcDir:event.isSrcDir,hasNowJson:event.hasNowJson,isCustomServer:event.isCustomServer,hasNextConfig:!!userConfiguration,buildTarget:(_userConfiguration$ta=userConfiguration==null?void 0:userConfiguration.target)!=null?_userConfiguration$ta:'default',hasWebpackConfig:typeof(userConfiguration==null?void 0:userConfiguration.webpack)==='function',hasBabelConfig:hasBabelConfig(dir)};return[{eventName:EVENT_VERSION,payload}];}
