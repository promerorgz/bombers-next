...
cache:!isWebpack5,babelPresetPlugins,hasModern:!!config.experimental.modern,development:dev,hasReactRefresh,hasJsxRuntime}},// Backwards compat
...
version:`${"9.5.4"}|${nextPublicVariables}|${nextEnvVariables}|${configVars}`,cacheDirectory:_path.default.join(dir,'.next','cache','webpack')};// Adds `next.config.js` as a buildDependency when custom webpack config is provided
